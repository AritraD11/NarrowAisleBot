...
a2.text(0.5, 0.885, 'Halving the heading threshold halved the\n'
        'largest step and pulled the peak correction\n'
        'under the gate. It changed the total by 2 %.',
...
fig, (b1, b2) = plt.subplots(1, 2, figsize=(9.6, 4.15),
...
for i, (v, n) in enumerate(zip(wall, nodes)):
    ...
    inside = v > 15
    b1.text(i, v/2 if inside else v + 16.0, f'{n}\npose-graph\n' + ('node' if n == 1 else 'nodes'),
