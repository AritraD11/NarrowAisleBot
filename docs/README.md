...
| [`Bench_Test_Map.md`](Bench_Test_Map.md) | Step-by-step breadboard bench test to isolate the level shifters — 3-stage plan (divider baseline → shifter #1 → shifter #2), wiring diagrams, decision tree, and result-reading guide. Start here when debugging encoder feedback. | v1.0, current |
